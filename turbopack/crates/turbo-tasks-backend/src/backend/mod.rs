            ...
            |task_id: TaskId,
             ...
             buffer: &mut TurboBincodeBuffer| {
                ...
                SnapshotItem {
                    ...
                    meta,
                    data,
                    // hash here to avoid cloning the Arc
                    task_type_hash: inner.flags.new_persistent_task().then_some(
                        compute_task_type_hash(inner.get_persistent_task_type().unwrap()),
                    ),
                }
            };
